...
String kmLogoChatDistanceTextGetter(
    String chatDistance, UserCoordinates userCoordinates) {
  switch (chatDistance) {
    case "world":
      return "World";
    case "country":
...
Widget appLogo(double Sizex, KmSystemSettings kmSystemSettings,
  ...
  return Container(
      ...
      decoration: BoxDecoration(
          border:
              Border.all(color: ColorConstants.designGreen, width: 2 * Sizex)),
      child: Column(
        children: [
          Text(
            "1KM",
            style: TextStyle(
              ...
              kmLogoChatDistanceTextGetter(kmSystemSettings.chatDistance, userCoordinates)!="null"?const SizedBox(
            height: 8,
          ):const SizedBox(),
